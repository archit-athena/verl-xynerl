    ...
    def get_openai_tool_schema(self) -> OpenAIFunctionToolSchema:
        ...
        return OpenAIFunctionToolSchema(
            ...
            function=OpenAIFunctionSchema(
                name="verl_read_file",
                description=f"Read files from the project directory ({self.verl_pwd}) using relative paths. Can read specific number of lines from the beginning of the file.",
